...
| **D4**      | Digital Output      | Stepper Driver 1 (IN4)     | no color     | Stepper control pin 1 (Motor 1)                                       |
| **D5**      | Digital Output      | Stepper Driver 1 (IN3)     | no color     | Stepper control pin 2 (Motor 1)                                       |
| **D6**      | Digital Output      | Stepper Driver 1 (IN2)     | no color     | Stepper control pin 3 (Motor 1)                                       |
| **D7**      | Digital Output      | Stepper Driver 1 (IN1)     | no color     | Stepper control pin 4 (Motor 1)                                       |
...
| **A1**      | Digital Input       | HX711 Module (DOUT)        | white        | Scale data line / DOUT                                                |
| **A2**      | Digital Output      | HX711 Module (PD_SCK)      | dark blue    | Scale clock line / SCK                                                |
| **A4**      | Hardware I2C (SDA)  | SSD1306 OLED Display (SDA) | brown white  | Display data line (I2C)                                               |
| **A5**      | Hardware I2C (SCL)  | SSD1306 OLED Display (SCL) | orange white | Display clock line (I2C)                                              |
